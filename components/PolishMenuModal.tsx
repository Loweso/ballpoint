...
const PolishModal: React.FC<PolishModalProps> = ({ visible, onClose }) => {
  return (
    <Modal 
      animationType="fade"
      transparent={true}
          ...
          <TouchableWithoutFeedback>
            <View className="bg-white rounded-lg flex-column shadow-md">
              <TouchableOpacity
                ...
                onPress={() => console.log('Summarize notes')}
              >
                <View className="flex-none p-1 rounded-md">
                  <MaterialCommunityIcons name="note-edit-outline" size={26} color="black" />
                </View>
                <Text className="flex-none text-black font-medium pr-2">Summarize notes</Text>
              </TouchableOpacity>
              ...
              >
                <View className="flex-none p-1 rounded-md">
                  <MaterialCommunityIcons name="note-check-outline" size={26} color="black" />
                </View>
                <Text className="flex-none text-black font-medium">Organize notes</Text>
              </TouchableOpacity>
            </View>
          </TouchableWithoutFeedback>
        </SafeAreaView>
